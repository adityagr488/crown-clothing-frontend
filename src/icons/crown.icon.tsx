const CrownIcon = () => {
    return (
        <svg width="50px" height="39px" viewBox="0 0 50 39">
            <g id="WiP" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g id="Artboard" transform="translate(-90.000000, -38.000000)">
                    <g id="Group" transform="translate(90.000000, 38.000000)">
                        <polygon id="Rectangle" fill="#756AB6" points="3 14 25 26.5 47 14 40.855176 39 9.08421785 39"></polygon>
                        <polygon id="Triangle" fillOpacity="0.262838724" fill="#756AB6" points="25 8 40 39 10 39"></polygon>
