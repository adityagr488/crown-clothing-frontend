const MobileIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({className, color}) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill={color} className={className}>
